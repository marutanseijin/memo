...
public class XLSXWriteTest {
        ...
        try {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                for (int j = 0; j < 10; j++) {
                    ...
                    cell.setCellFormula("ROUND(" + XLSXWriteTest.getExcelColumnString(colNumber - 3) + (rowNumber + 1)
                            + "*1.08, 0)");
    ...
    private final static String[] LIST_ALPHA = { "A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L", "M", "N",
